"""
Django settings for Internshala20 project.
...
SECRET_KEY = 'django-insecure-v!t6ispjt=q%%jz@_*$!wnjsnxyt)ttpw6taneaikp706a_h^k'
...
ROOT_URLCONF = 'Internshala20.urls'
...
WSGI_APPLICATION = 'Internshala20.wsgi.application'
